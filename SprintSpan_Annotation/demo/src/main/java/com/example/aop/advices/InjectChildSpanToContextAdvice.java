...
import com.example.InjectChildSpanToContext;
...
public class InjectChildSpanToContextAdvice {
    ...
    @Around("@annotation(com.example.InjectChildSpanToContext) && execution(* *(..))")
    public Object injectSpan(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {

        OpenTelemetry openTelemetry = GlobalOpenTelemetry.get();
        Object object;
        System.out.println("In InjectChildSpanToContextAdvice!");
        try {
